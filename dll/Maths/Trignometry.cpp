...
extern "C" EXPORT void coda_sin(IValuePtr res, IValuePtr args, IEnvironment * env) {
...
extern "C" EXPORT void coda_cos(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_tan(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_asin(IValuePtr res, IValuePtr args, IEnvironment * env) {
...
extern "C" EXPORT void coda_acos(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double value = std::stod(args->getProperties()["value"]->getValue());
...
extern "C" EXPORT void coda_atan(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double value = std::stod(args->getProperties()["value"]->getValue());
...
extern "C" EXPORT void coda_sec(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_csc(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_cot(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_sinh(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_cosh(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
...
extern "C" EXPORT void coda_tanh(IValuePtr res, IValuePtr args, IEnvironment * env) {
	double angle = std::stod(args->getProperties()["angle"]->getValue());
