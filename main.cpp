...
int repl() {
	...
	env.declareOrAssignVariable("none", Coda::Runtime::Value(Coda::Runtime::Type::NONE, "none", Position(), Position()),true);
	env.declareOrAssignVariable("undefined", Coda::Runtime::Value(Coda::Runtime::Type::UNDEFINED, "undefined", Position(), Position()), true);
	env.declareOrAssignVariable("true", Coda::Runtime::Value(Coda::Runtime::Type::BOOL, "1", Position(), Position()), true);
	env.declareOrAssignVariable("false", Coda::Runtime::Value(Coda::Runtime::Type::BOOL, "0", Position(), Position()), true);
